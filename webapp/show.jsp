...
<body>
	...
	<div id="main">
		...
		<div>
			...
			<lable name="errorMessage">${errorMessage}</lable>
		</div>
		...
		<div class="comments">
			...
			<c:forEach items="${answers}" var="each">
				<div id="${each.answerId}" class="comment">
					...
					<div class="comment_link">
						<a href="#" data-answerId="${each.answerId}"
							data-questionId="${question.questionId}">삭제</a>
					</div>
				</div>
			</c:forEach>
		</div>
